...
int main(int argc, char *argv[]) {
         ...
         * so you don't need to add or link GstElement any more.
         */
        ...
        /* Listen to the bus 
         * Playbin is a GstPipeline. It will notify the application of everything that's happening 
         *  (errors, end of stream, tags found, state changes, etc.) by posting messages on its GstBus. 
         *  The application needs to watch the bus.
         */
        long int count = 0;
